...
vim.o.scrolloff = 3 -- Minimal number of screen lines to keep above and below the cursor (default: 0)
vim.o.sidescrolloff = 5 -- Minimal number of screen columns either side of cursor if wrap is `false` (default: 0)
